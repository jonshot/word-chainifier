...
(function (module) {
    ...
    module.exports = {
         ...
         *  @param function onComplete Callback function to execute when chain found
         *  
         * @returns array The word chain
         */
        buildChain: function (params, onComplete) {
            ...
            _findChain(_wordsFactory(params), onComplete);
        }
    };
}(module));